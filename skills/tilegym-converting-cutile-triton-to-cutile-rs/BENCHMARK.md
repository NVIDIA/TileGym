...
Evaluation of the `tilegym-converting-cutile-triton-to-cutile-rs` skill before publication through NVSkills-Eval.
...
- LOW SCHEMA/unexpected_file: Unexpected 'agents' in skill root (`skills/tilegym-converting-cutile-triton-to-cutile-rs/agents`)
