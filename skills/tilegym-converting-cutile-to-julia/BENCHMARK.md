...
| Correctness | 5 | 100% (+20%) | 97% (+11%) |
| Discoverability | 5 | 100% (+20%) | 93% (+1%) |
| Effectiveness | 5 | 99% (+17%) | 96% (+15%) |
| Efficiency | 5 | 96% (+13%) | 89% (-0%) |
...
- MEDIUM SECURITY/Unknown (SQP-2): The workflow explicitly instructs the agent to auto-proceed through all phases without user confirmation, including file (`translations/workflow.md:26`)
