...
- MEDIUM SECURITY/Unknown (SQP-2): The skill explicitly lists shell commands and files as output types but does not include explicit warnings to users that (`skill-card.md:34`)
